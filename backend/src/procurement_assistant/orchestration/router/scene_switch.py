...
from procurement_assistant.delegates.database.interface import DatabaseDelegate, ScenarioRecord
...
from procurement_assistant.protocol.events import ProcurementEventName, ScenePayload
...
class SceneSwitchCoordinator:
    ...
    async def handle(
        ...
        *,
        ...
        if operation == ActionOperation.CANCEL_SCENE_SWITCH:
            await context.call_database(
        ...
        if operation != ActionOperation.CONFIRM_SCENE_SWITCH:
