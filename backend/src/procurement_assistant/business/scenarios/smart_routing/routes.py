...
def recommendation_action(state: SmartRoutingState) -> str:
    ...
    routes = {
        BusinessActionOperation.NEXT_PAGE: "next_page",
        BusinessActionOperation.APPEND_PRODUCT: "append_product",
        BusinessActionOperation.OTHER_PROCUREMENT_MODE: "other_mode",
        BusinessActionOperation.END_RECOMMENDATION: "end",
    }
