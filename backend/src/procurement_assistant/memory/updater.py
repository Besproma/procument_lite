...
from procurement_assistant.delegates.common.call_context import DelegateCallContext, RunDeadline
...
from procurement_assistant.domain.errors import DelegateTimeoutError, RetryableDelegateError
from procurement_assistant.domain.procurement import MemoryPatch, MemoryUpdateInput
        ...
        for attempt in range(1, self._settings.delegate_max_attempts + 1):
            ...
            try:
                async with collector.start_span(
                    ...
                    target=ModelTaskId.MEMORY_UPDATE.value,
                    attempt=attempt,
                    ...
                    try:
                        async with asyncio.timeout(timeout_seconds):
                            patch = await self._model.invoke_structured(
                                task_id=ModelTaskId.MEMORY_UPDATE,
